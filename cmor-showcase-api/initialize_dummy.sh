...
# Setup cmor-showcase
rails generate cmor:showcase:install
rails cmor_showcase:install:migrations

# Setup cmor-showcase-api
BASE_CONTROLLER_CLASS_NAME=ApiController rails generate cmor:showcase:api:install
