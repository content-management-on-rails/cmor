  ...
  module UserArea
    module Frontend
      module SpecHelpers
        # Usage:
        #
        #    # spec/support/cmor_user_area_frontend.rb
        ...
        module Feature
          def sign_up(user_attributes)
            visit "/#{I18n.locale}/#{I18n.t("routes.cmor_user_area_frontend_engine")}/#{I18n.t("routes.current_user")}/new"
          ...
          #       include Cmor::UserArea::Frontend::SpecHelpers::Feature
          #
