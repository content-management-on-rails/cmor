...
rails cmor_testimonials:install:migrations

# Setup cmor-testimonials-api
BASE_CONTROLLER_CLASS_NAME=ApiController rails generate cmor:testimonials:api:install
